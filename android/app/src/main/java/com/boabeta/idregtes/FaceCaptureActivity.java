...
public class FaceCaptureActivity extends AppCompatActivity {
        ...
        private void startCapture() {
                ...
                try {
                        ...
                        boolean useBackCamera = getIntent().getBooleanExtra(
                                        "useBackCamera",
                                        false);
                        ...
                        int brisqueThreshold = getIntent().getIntExtra(
                                        "brisqueThreshold",
                                        60);

                        double livenessThreshold = getIntent().getDoubleExtra(
                                        "livenessThreshold",
                                        0.5);
                        ...
                        controller.startFaceCapture(
                                        ...
                                        new FaceCaptureListener() {
                                                ...
                                                public void onFaceCaptured(
                                                        ...
                                                        // faceBox
                                                        // );
                                                        Log.d(TAG, "Face capture liveness: " + faceBox.mLiveness);
                                                ...
                                                try {
                                                        ...
                                                        Log.e(TAG, "Error retrieving liveness or brisque from faceBox", ignored);
                                                }
                                                }

                                                resultIntent.putExtra("faceBoxLiveness", liveness);
                                                resultIntent.putExtra("faceBoxBrisque", brisque);
                                                ...
                                                public void OnFaceCaptureFailed(String errorMessage) {
                                                        ...
                                                        returnResult(Activity.RESULT_CANCELED, errorMessage);
                                                }

                                                @Override
                                                public void onTimedout(byte[] faceImage) {
                                                        Log.e(TAG, "Timeout");
                                                        returnResult(Activity.RESULT_CANCELED, "timeout");
                                                }

                                                @Override
                                                public void onCancelled() {
                                                        Log.e(TAG, "Cancelled");
                                                        returnResult(Activity.RESULT_CANCELED, "cancelled");
                                                }
                                        });
        ...
        private void returnResult(int code, String error) {
